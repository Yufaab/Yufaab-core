...
public enum AppErrorCodes {
  ...
  STUDENT_NOT_ABLE_TO_LOGOUT("Logout failed due to some error", HttpStatus.BAD_REQUEST),
  STUDENT_ALREADY_LOGGED_OUT("Student already logged out", HttpStatus.NOT_FOUND),
